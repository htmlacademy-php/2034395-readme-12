                        ...
                        <div class="post__main">
                            <div class="post-link__wrapper">
                                <a class="post-link__external" target="_blank"
                                   href="<?= htmlspecialchars($post['site_url']); ?>"
                                    ...
                                    <li class="comments__item user">
                                        <div class="comments__avatar">
                                            <a class="user__avatar-link"
                                               href="../img/<?= $el['avatar_url'] ?? 'userpic.jpg' ?>">
                                                <img class="comments__picture"
                                                     src="../img/<?= $el['avatar_url'] ?? 'userpic.jpg' ?>"
                                                     alt="Аватар пользователя">
                                            </a>
                                        </div>
                    ...
                    <div class="post-details__rating user__rating">
                        ...
                        <p class="post-details__rating-item user__rating-item user__rating-item--publications">
                            ...
                            <span class="post-details__rating-text user__rating-text">
                                <?= get_noun_plural_form(count($user_posts), 'публикация', 'публикации',
                                    'публикаций') ?>
                            </span>
                        </p>
                    </div>
